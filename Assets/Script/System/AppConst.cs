...
namespace Const
{
    ...
    public static class Const_Skill
    {
        ...
        public static readonly Skill[] SKILLS = new Skill[SKILL_NUM]
        {
            ...
            new Skill(20    , 3.0f  , 10.0f ),
            new Skill(20    , 3.0f  , 10.0f ),
            new Skill(80    , 3.0f  , 10.0f ),
            new Skill(100   , 3.0f  , 0.5f  ),
            new Skill(50    , 3.0f  , 0.5f  ),
            new Skill(50    , 3.0f  , 0.5f  ),
            new Skill(100   , 3.0f  , 10.0f ),
            new Skill(50    , 3.0f  , 10.0f ),
            new Skill(20    , 3.0f  , 0.5f  ),
            new Skill(50    , 3.0f  , 0.5f  ),
        };
